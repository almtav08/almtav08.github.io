...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:_n,depthTest:!1,depthWrite:!1})}function Za(){return new Hn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Nr(),fragmentShader:`
		...
		`,blending:_n,depthTest:!1,depthWrite:!1})}function $a(){return new Hn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Nr(),fragmentShader:`
		...
		`,blending:_n,depthTest:!1,depthWrite:!1})}function Nr(){return`
...
`].filter(Ii).join(`
`)),a=Tr(a),a=ao(a,t),a=oo(a,t),o=Tr(o),o=ao(o,t),o=oo(o,t),a=co(a),o=co(o),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(T=`#version 300 es
